...
export const articles: Article[] = [
  {
    title: "아트바젤 홍콩 2026 Zero 10",
    description: "디지털 시대의 예술",
    date: "2026.04",
    tags: ["아트로그", "해외전시"],
    source: "Blog",
  ...
  {
    title: "빌보드 싱어송라이터 줄리아 마이클스 Julia Michaels",
    description: "야너두 들어봤을 거야",
    date: "2025.05",
    tags: ["모데라토", "아티스트"],
    source: "Blog",
  ...
  {
    title: "2026 화랑미술제 감상 가이드",
    description: "네임드부터 라이징까지",
    date: "2026.04",
    tags: ["아트로그", "국내전시"],
    source: "Blog",
  ...
  {
    title: "자크 루이 다비드 〈마라의 죽음 La Mort de Marat〉",
    description: "여론을 뒤집는 힘",
    date: "2025.04",
    tags: ["아트로그", "작품소개"],
    source: "Blog",
  ...
  {
    title: "Coldplay(콜드플레이) — Viva La Vida",
    description: "그것이 나의 제국이었네",
    date: "2025.04",
    tags: ["모데라토", "곡소개"],
    source: "Blog",
