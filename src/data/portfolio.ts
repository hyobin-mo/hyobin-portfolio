...
export const projects: Project[] = [
  {
    ...
    details: [
      ...
      },
      {
        ...
        concept: "전략기획부 사원",
        story:
          "수림문화예술 서포터즈 1기로 수용자의 관점에서 운영을 이해하고, 2기에서는 프로젝트 매니저(PM)로 프로젝트를 조율하며, 3기에선 사업담당자로 총괄하며, 기획의 전 과정을 주체적으로 경험했습니다.",
      ...
      },
      {
        ...
        concept: "교육팀 에듀케이터",
        story:
          "프랑스 작가 에르베 튈레의 교육 프로그램을 운영하며, 국제 예술가와 협업할 때 요구되는 기획 감각과 조율 능력을 체득했습니다.",
      ...
      },
      {
        ...
        concept: "인턴",
        story:
          "작가 리서치와 자료정리, 작품 관리 등 전시를 구성하는 기초 큐레이션 실무를 탄탄하게 익혔습니다.",
